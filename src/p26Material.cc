...
//#include "p26MaterialData.hh"
#include "p26MaterialMessenger.hh"
...
////////////////////////////////////////////////////////////////////////////////
//
p26Material::p26Material()
{



	G4double fractionmass; //fractional mass of a material.
  ...
  elementLa = new G4Element("Lanthanum", "La",57.,  138.91*g/mole); //Marco
  elementBr = new G4Element("Bromine",   "Br",35.,  79.904*g/mole); //Marco
  
  elementNa = new G4Element("Sodium",    "Na",11.,  22.990*g/mole); //added 15 Aug 2013 MBB
  elementI  = new G4Element("Iodine",    "I", 53., 126.905*g/mole); //added 15 Aug 2013 MBB 
...
// Materials
  ...
  Air->AddElement(elementN, fractionmass=0.7);
  Air->AddElement(elementO, fractionmass=0.3);

 polystyrene = new G4Material("polystyrene", 1.60*g/cm3, 2);
 polystyrene->AddElement(elementC,8);
 polystyrene->AddElement(elementH,8);
  ...
  LanthanumBromide = new G4Material("LanthanumBromide", 5.06*g/cm3, 2);
  LanthanumBromide->AddElement(elementLa,1);
  LanthanumBromide->AddElement(elementBr,3);
  
  SodiumIodide = new G4Material("SodiumIodide", 3.67*g/cm3,2);
  SodiumIodide->AddElement(elementNa,1);
  SodiumIodide->AddElement(elementI,1);
  

  Al = new G4Material("Al", 13, 26.98153*g/mole,  2.70*g/cm3);
  Nb = new G4Material("Nb", 41, 92.90638*g/mole,  8.57*g/cm3);
  C  = new G4Material("C",   6, 12.011*g/mole,    2.26*g/cm3); //changed from 2.15 g/cm^3 -- 15 Aug 2013 MBB
  ...
  La = new G4Material("La", 57., 138.91*g/mole,  6.146*g/cm3); //changed from 6.162 g/cm^3 -- 15 Aug 2013 MBB
  Br = new G4Material("Br", 35., 79.904*g/mole,   3.12*g/cm3); //changed from 3.103*g/cm^3 -- 15 Aug 2013 MBB
  Na = new G4Material("Na", 11., 22.990*g/mole,  0.968*g/cm3); //added 15 Aug 2013 MBB
  I  = new G4Material("I",  53., 126.91*g/mole,   4.94*g/cm3); //added 15 Aug 2013 MBB
...
//   }
  ...
  materialMessenger = new p26MaterialMessenger(this);
}
////////////////////////////////////////////////////////////////////////////////
//
p26Material::~p26Material ()
...
//
/*
void p26Material::AddMaterial (G4String name, G4String formula, G4double density,
...
////////////////////////////////////////////////////////////////////////////////
//
void p26Material::DeleteMaterial (G4int j)
{
  size_t i(j-1);
  if (i > Material.size()) {
...
////////////////////////////////////////////////////////////////////////////////
//
void p26Material::DeleteMaterial (G4String )
{
  G4cerr <<"It seems there is no mechanism in G4 for deleting a material yet!"
         <<G4endl;
  G4cerr <<"--> Command rejected." <<G4endl;
...
////////////////////////////////////////////////////////////////////////////////
//
G4int p26Material::GetMaterialIndex (G4String name)
{
  size_t i ;
  for (i = 0; i < Material.size(); i++) {
