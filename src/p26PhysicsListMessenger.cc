...
p26PhysicsListMessenger::p26PhysicsListMessenger(p26PhysicsList* pPhys)
:pPhysicsList(pPhys)
{   
  physDir = new G4UIdirectory("/p26/phys/");
  physDir->SetGuidance("physics control.");

  gammaCutCmd = new G4UIcmdWithADoubleAndUnit("/p26/phys/setGCut",this);  
  ...
  electCutCmd = new G4UIcmdWithADoubleAndUnit("/p26/phys/setECut",this);  
  ...
  protoCutCmd = new G4UIcmdWithADoubleAndUnit("/p26/phys/setPCut",this);  
  ...
  allCutCmd = new G4UIcmdWithADoubleAndUnit("/p26/phys/setCuts",this);
  ...
  eCutCmd = new G4UIcmdWithADoubleAndUnit("/p26/phys/TargetCuts",this);
  ...
  mCutCmd = new G4UIcmdWithADoubleAndUnit("/p26/phys/DetectorCuts",this);
  ...
  pListCmd = new G4UIcmdWithAString("/p26/phys/SelectPhysics",this);
...
p26PhysicsListMessenger::~p26PhysicsListMessenger()
{
  delete physDir;
  delete gammaCutCmd;
  delete electCutCmd;
...
void p26PhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{
