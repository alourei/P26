...
#ifndef p26PhysListHadron_h
#define p26PhysListHadron_h 1
...
class p26PhysListHadron : public G4VPhysicsConstructor 
{
  public:
    p26PhysListHadron(const G4String& name = "hadron");
    virtual ~p26PhysListHadron();
